...
const HomeCompo = () => {
  return (
    <>
      <div className="w-[5000px] h-[555px] bg-[rgba(0,0,0,0.5)] overflow-hidden rounded-2xl items-center flex pl-5 justify-between pr-5">
        ...
        <div className="fuhadShiblu_animated w-[360px] h-[360px] bg-black rounded-full flex justify-center items-center">
            <img className="w-[350px] h-[350px] rounded-full" src={myProfile} alt="Profile" />
        </div>
      </div>
    </>
  )
